...
class UCMLK:
    def __init__(self, env, c, gamma, N, eta, T):
        self.env = env
        ...
        # self.reachable_states[(0,0)] = {0}
        # self.reachable_states[(0,1)] = {1}
        # self.reachable_states[(1,0)] = {0}
        # self.reachable_states[(1,1)] = {1}
...
# agent = UCMLK(env, c=1e-2, gamma=0.9, N=10, eta=0.1 , T=100)
# agent.run()